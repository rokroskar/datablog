...
<p><strong>TL;DR:</strong> Collecting Spark metrics in tools like <a href=http://prometheus.io>Prometheus</a> is <emph>easy</emph> and can be done by <emph>anyone</emph> with or without admin priviledges. 
</p></div>
